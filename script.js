(function () {
      ...
      */
        (function () {
                var favicon = 'favicon', online = 'online', $status = document.getElementById('status'), slash = '/',
                    dot = '.', parser = 'parser', semicolumn = ':', json = 'json',
                    $head = document.querySelector('head'), $result = document.getElementById('result'),
                    $editor = document.getElementById('editor'), fr = 'fr', event_keyup = 'keyup',
                    event_click = 'click',
                ...
                (function () {
                        var startX, startY, startWidth, startHeight, startHeight2,
                            ...
                            resizer = document.querySelector('.ui-resizer'), doDrag = function (e) {
