...
$(function() {
    // setTimeout(function() {
    //     var c = '<a id="nC" title="Make a donation via PayPal" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=2LC8WEVSDYGFU" target="_new">You like it? <span id="support-it">Support it!</span> <u id="donate">Donate</u></a>';
...
$(function(d) {
    ...
    /**
     * Commenté car ce code semble bloquer le JS si on est pas réellement sur le domaine du site d'origine
     */
    ...
    function E(O) {
        ...
        function H(U) {
            ...
            if (U.indexOf("]") === 0) {
                U.shift(1);
                U.update('</ol><span class="toggle-end" card="Tableau vide, comme mes couilles">]</span>');
            ...
            U.update('</ol><span class="toggle-end" card="' + (V + 1) + suffix + '">]</span>');
            return U.update("</span>")
        }
    ...
    function j(J) {
        var K = a.val(),
            I = '<link rel="icon" type="image/png" href="/guyicon',
            H = '.png" id="favicon"/>';
        if (d.trim(K) === "") {
            r.html("");
            n.html("");
        ...
        if (l.hasClass("on")) {
            setTimeout(function() {
                ...
                if (M.valid) {
                    ...
                    B.html("String parse:&nbsp;"+invalidMessage+" <b>" + L + "&nbsp;error" + (L > 1 ? "s" : "") + "</b>");
